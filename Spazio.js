...
function setup() {
  ...
  spazio=[new Letter("S", new p5.Vector(300, .4*height), col1,-1), new Letter("P", new p5.Vector(400, .4*height), col1,-1), new Letter("A", new p5.Vector(500, .4*height), col1,-1), 
    new Letter("Z", new p5.Vector(600, .4*height), col1,-1), new I(new p5.Vector(700, .4*height), col3, 0, random(1)>.5?-1:1), new O(new p5.Vector(800, .4*height), col3, col3,random(1)>.5?-1:1)];
  cosmico=[new Letter("C", new p5.Vector(300, .6*height), col1,1), new O(new p5.Vector(420, .6*height), col1, col1, random(1)>.5?-1:1), new Letter("S", new p5.Vector(530, .6*height), col2,0)
    ,new Letter("M", new p5.Vector(630, .6*height), col1,1), new I(new p5.Vector(720, .6*height), col3, 0, random(1)>.5?-1:1), new Letter("C", new p5.Vector(800, .6*height), col1,1), 
